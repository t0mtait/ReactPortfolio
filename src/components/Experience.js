        ...
        return (
            ...
            <div
                ...
                <div className="mt-4 md:mt-0">
                    <img className="w-1/2 block" src="verosource.png" alt="Verosource logo"/>
                    <h2 className="mb-1 text-sm tracking-tight font-extrabold text-white ">Software Developer</h2>
                    <h2 className="mb-4 text-sm tracking-tight font-extrabold text-white ">January 2025 - August 2025</h2>
                    <ul className="max-w-md space-y-1 text-white text-xs list-disc list-inside ">
                        ...
                        <li>
                            Created and managed TLS certificates for client and organization domains.
                        </li>
                        <li>
            ...
            <div
                ...
                <div className="mt-4 md:mt-0">
                    <img className="mt-5 w-1/2 block" src="sonrai.png" alt="Sonrai Security logo"/>
                    <h2 className="mb-1 text-sm tracking-tight font-extrabold text-white ">Software Developer</h2>
                    ...
                    <ul className="max-w-md space-y-1 text-white text-xs list-disc list-inside ">
                        ...
                        <li>
                            Wrote a script to destroy unused resources nightly to cut cloud costs.
                        </li>
                    </ul>
                </div>
    ...
    else
    {
        return (
            ...
            <div
                ...
                <img className="w-3/4 block" src="verosource.png" alt="Verosource logo"/>
            </div>
            <div
                className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                ...
                <img className="mt-5 w-3/5 block" src="sonrai.png" alt="Sonrai Security logo"/>
            </div>
