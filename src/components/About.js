    ...
    if (isMobile) {
        ...
        <section className="bg-transparent">
            <div className="grid w-full px-4 py-8">
                <div className="flex mr-auto place-self-center col-span-2">
                    <div>
                        <h1 className="max-w-2xl mb-4 text-2xl font-extrabold tracking-tight ading-none md:text-5xl xl:text-6xl text-white">Hi, I'm Tom!</h1>
        ...
        <section className="bg-transparent">
            <div className="flex max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-4">
                <div className="mr-auto place-self-center lg:col-span-5 sm:col-span-1">
