...
function Projects () {
    ...
    if (isMobile) {
        ...
        <section id = "projects">
            ...
            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <div className="mt-4 md:mt-0">
                    <h2 className="mb-1 text-2xl tracking-tight font-extrabold text-white ">Stack Tracker</h2>
                    <img className="w-full mt-5 border-2 rounded-xl dark:block" src="stacktracker.png" alt="dashboard"/>
                    <ul className="max-w-md mt-5 space-y-1 text-white list-disc list-inside ">
                        <li>
                            React + HAPI-FHIR + PSQL
                        </li>
                        <li>
                            Users track their supplement regimen and history.
                        </li>
                        <li>
                    ...
                    <div className="mt-4">
                        <a href="https://github.com/t0mtait/stack-tracker" target="_blank" rel="noopener noreferrer" 
            ...
            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img className="w-full  border-2 rounded-xl dark:block" src="celticai.png" alt="celtic-ai"/>
                <div className="mt-4 md:mt-0">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white ">Celtic-AI</h2>
                    <ul className="max-w-md space-y-1 text-white list-disc list-inside ">
                        <li>
                            Machine learning project.
                        </li>
                        <li>
                            Use statistics to predict whether the Celtics will win a game.
                        </li>
                        <li>
                            Rank team statistics by their impact on game outcome.
                        </li>
                    </ul>
                    <div className="mt-4">
                        <a href="https://github.com/t0mtait/celtic-ai" target="_blank" rel="noopener noreferrer" 
        ...
        <section id = "projects">
            ...
            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img className="w-full  border-2 rounded-xl dark:block" src="stacktracker.png" alt="Stack Tracker dashboard"/>
                <div className="mt-4 md:mt-0">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-white ">Stack Tracker</h2>
                    <ul className="max-w-md space-y-1 text-white list-disc list-inside ">
                        <li>
                            React + HAPI-FHIR + PSQL
                        </li>
